...
function Cart() {
    const { cartItems, updateQuantity, removeItem, subtotal, total } = useContext(CartContext);
    ...
    return (
        <div className="min-h-screen bg-[#FFF9F4] text-[#5C2C06] flex flex-col relative">
            ...
            <div className="max-w-4xl mx-auto w-full mt-20 p-6">
                <h1 className="text-4xl font-semibold mb-6 text-center uppercase">Your Cart</h1>
                    ...
                    <>
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#5C2C06]/70 flex items-center">₹{item.price} • each</p>
                                        </div>
                                    </div>
                        ...
                        <div className="mt-8 bg-white/60 backdrop-blur-md rounded-2xl shadow-lg p-6 text-right space-y-3">
                            ...
                            <div className="flex justify-between border-t border-[#C68B59]/30 pt-3">
                                ...
                                <p className="text-xl font-semibold">₹{total + 50}</p>
                            </div>
