...
export default function Contact() {
    return (
        <div className="bg-[#FFF9F4] min-h-screen py-8 px-6 md:px-16">
            ...
            >
                <div className="flex flex-col md:flex gap-10 md:gap-10">
                    
                    {/* Contact Information */}
                    <div className="border border-[#E6D5C3] rounded-lg item-center p-2 bg-[#FFF9F4] flex flex-col justify-center space-y-6 text-[#5C2C06]">
                        
                        <div className="flex items-center gap-4">
                            <FaEnvelope className="text-[#C68B59] text-2xl" />
                            <p className="text-lg">diamondenterprises.1260@gmail.com</p>
                        </div>
                        <div className="flex items-center gap-4">
                            <FaPhoneAlt className="text-[#C68B59] text-2xl" />
                            <p className="text-lg">+91 73592 54550</p>
                        </div>
                    </div>
